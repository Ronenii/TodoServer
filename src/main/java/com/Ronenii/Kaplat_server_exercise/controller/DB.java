...
public class DB {
//
//    private List<TODOPostgres> todos = new ArrayList<TODOPostgres>();
//
...
//    }
//
//    public void addTodo(TODOPostgres todo)
//    {
//        todos.add(todo);
//    }
//
...
//    public boolean TodoExists(TODOPostgres todo) {
//        for (TODOPostgres t : todos) {
...
//    public boolean TodoHasCorrectTime(TODOMongodb todo) {
...
//    }
//
//    public void sortTodos(ArrayList<TODOPostgres> resultArray, String status, String sortBy) {
//        StringBuilder errorMessage = new StringBuilder();
//
...
//    public void addToArrayByStatus(ArrayList<TODOPostgres> resultArray, String status) {
//        for (TODOPostgres t : todos) {
...
//    public void SortTodosWithSortby(List<TODOPostgres> resultArray, String sortBy) {
//        if (sortBy.isEmpty()) {
//            sortBy = "ID";
//        }
